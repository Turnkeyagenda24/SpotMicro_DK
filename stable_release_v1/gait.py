...
class GaitController:
    ...
    def get_crawl_targets(self, pos_x, pos_y, pos_z, hip_x_offsets, current_positions):
        ...
        left_phase = (current_phase - leg_offsets['FL']) % 1.0
        right_phase = (current_phase - leg_offsets['FR']) % 1.0

        left_legs_swinging = left_phase < 1.0 / NUM_PHASES
        right_legs_swinging = right_phase < 1.0 / NUM_PHASES
        ...
        for leg_id in ['FL', 'FR', 'BL', 'BR']:
            ...
            is_swinging = leg_phase < 1.0 / NUM_PHASES
